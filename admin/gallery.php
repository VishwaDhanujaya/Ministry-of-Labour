                    ...
                    <tr class="hover:bg-gray-50 transition-colors group">
                        <td class="py-4 px-6">
                            <?php if(!empty($gallery['cover_image']) && file_exists($gallery['cover_image'])): ?>
                                <img loading="lazy" src="<?= htmlspecialchars($gallery['cover_image']) ?>" class="w-12 h-12 rounded object-cover border border-gray-200 shadow-sm">
                            <?php else: ?>
                        ...
                        <td class="py-4 px-6">
                            <div class="flex items-center space-x-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                ...
                                <a href="gallery.php?delete=<?= $gallery['id'] ?>&csrf_token=<?= generateCsrfToken() ?>" onclick="return confirm('Are you sure you want to delete this album and all its images?');" class="js-delete-row p-1.5 text-gray-400 hover:text-red-500 transition-colors" title="Delete">
