        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
            <table class="js-filterable-table w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100 text-[13px]">
                    ...
                    <tr>
                        <td colspan="6" class="py-5 px-6 text-center text-gray-500">No gallery albums found.</td>
                    </tr>
                    <?php else: ?>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors group">
                        ...
                        <td class="py-4 px-6">
                            ...
                            <span class="px-3 py-1 rounded bg-blue-100 text-blue-800 text-[11px] font-bold">Public</span>
                            <?php else: ?>
                            <span class="px-3 py-1 rounded bg-gray-200 text-gray-800 text-[11px] font-bold">Private</span>
                            <?php endif; ?>
                        </td>
                        <td class="py-4 px-6">
                            <div class="flex items-center space-x-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                <a href="new-gallery.php?id=<?= $gallery['id'] ?>" class="px-3 py-1.5 border border-gray-200 rounded text-gray-600 text-[11px] font-bold hover:bg-gray-50 transition-colors">Edit</a>
                                <a href="gallery.php?delete=<?= $gallery['id'] ?>" onclick="return confirm('Are you sure you want to delete this album and all its images?');" class="px-3 py-1.5 border border-red-200 rounded text-red-500 text-[11px] font-bold hover:bg-red-50 transition-colors">Delete</a>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; ?>
