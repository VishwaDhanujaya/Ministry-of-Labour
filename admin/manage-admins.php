...
<div class="flex-1 flex flex-col min-w-0 bg-white relative z-10">
    ...
    <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 md:p-10">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="py-4 px-6 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <a href="manage-admins?delete=<?= $adm['id'] ?>&csrf_token=<?= generateCsrfToken() ?>" onclick="return confirm('Are you sure you want to delete this admin?');" class="p-1.5 text-gray-400 hover:text-red-500 transition-colors" title="Delete">
        ...
        <div id="adminModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 backdrop-blur-sm p-4" style="z-index: 9999;">
