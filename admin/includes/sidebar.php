    ...
    <div id="sidebar-nav" class="flex-1 py-6 overflow-y-auto custom-scrollbar flex flex-col opacity-0 transition-opacity duration-150">
        ...
        <div class="mb-6">
            ...
            <ul class="space-y-1 px-3">
                ...
                <li>
                    <a href="manage-iau-downloads" class="flex items-center px-4 py-2.5 rounded-lg <?= ($current_page == 'manage-iau-downloads' || $current_page == 'new-iau-download') ? 'bg-white text-secondary shadow-sm' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-all duration-200">
                        ...
                        <span>IAU Downloads</span>
                    </a>
                </li>
                <li>
                    <a href="manage-iau-updates" class="flex items-center px-4 py-2.5 rounded-lg <?= ($current_page == 'manage-iau-updates' || $current_page == 'new-iau-update' || $current_page == 'manage-iau-images') ? 'bg-white text-secondary shadow-sm' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-all duration-200">
                        <svg class="w-5 h-5 mr-3 shrink-0 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                        <span>IAU Updates (Gallery)</span>
                    </a>
                </li>
                <?php endif; ?>
            </ul>
