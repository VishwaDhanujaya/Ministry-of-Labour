...
<aside class="w-64 bg-[#4E0000] text-white flex flex-col h-full shrink-0 z-20">
    ...
    <div class="flex-1 py-8 custom-scrollbar">
        ...
        <div class="mb-8">
            ...
            <ul>
                <li>
                    <a href="articles.php" class="flex items-center px-8 py-2.5 <?= ($current_page == 'articles') ? 'bg-white text-[#4E0000]' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-colors">
                        <span>Articles</span>
                    </a>
                </li>
                <li>
                    <a href="new-article.php" class="flex items-center px-8 py-2.5 <?= ($current_page == 'new-article') ? 'bg-white text-[#4E0000]' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-colors">
