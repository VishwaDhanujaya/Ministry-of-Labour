    ...
    <div class="flex-1 py-6 overflow-y-auto custom-scrollbar flex flex-col">
        ...
        <div class="mb-8">
            ...
            <ul>
                ...
                <li>
                    <a href="manage-special-notices" class="flex items-center px-8 py-2.5 <?= ($current_page == 'manage-special-notices' || $current_page == 'new-special-notice') ? 'bg-white text-[#4E0000]' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-colors">
        ...
        <div class="mb-8">
            ...
            <ul>
                ...
                <li>
                    <a href="manage-statistics" class="flex items-center px-8 py-2.5 <?= ($current_page == 'manage-statistics') ? 'bg-white text-[#4E0000]' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-colors">
