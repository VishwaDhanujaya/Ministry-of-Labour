    ...
    <div id="sidebar-nav" class="flex-1 py-6 overflow-y-auto custom-scrollbar flex flex-col" style="opacity: 0;">
        ...
        <div class="mb-6">
            ...
            <ul class="space-y-1 px-3">
                <li>
                    <a href="dashboard" class="flex items-center px-4 py-2.5 rounded-lg <?= ($current_page == 'index' || $current_page == 'dashboard' || $current_page == '') ? 'bg-white text-[#4E0000] shadow-sm' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-all duration-200">
        ...
        <div class="mb-6">
            ...
            <ul class="space-y-1 px-3">
                <li>
                    <a href="news" class="flex items-center px-4 py-2.5 rounded-lg <?= ($current_page == 'news' || $current_page == 'news-add') ? 'bg-white text-[#4E0000] shadow-sm' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-all duration-200">
                ...
                <li>
                    <a href="manage-special-notices" class="flex items-center px-4 py-2.5 rounded-lg <?= ($current_page == 'manage-special-notices' || $current_page == 'new-special-notice') ? 'bg-white text-[#4E0000] shadow-sm' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-all duration-200">
                        <svg class="w-5 h-5 mr-3 shrink-0 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg>
                        <span>Special Notices</span>
                    </a>
                </li>
                <li>
                    <a href="manage-iau-updates" class="flex items-center px-4 py-2.5 rounded-lg <?= ($current_page == 'manage-iau-updates' || $current_page == 'new-iau-update') ? 'bg-white text-[#4E0000] shadow-sm' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-all duration-200">
        ...
        <div class="mb-6">
            ...
            <ul class="space-y-1 px-3">
                <li>
                    <a href="manage-learning-platforms-local" class="flex items-center px-4 py-2.5 rounded-lg <?= ($current_page == 'manage-learning-platforms-local' || $current_page == 'new-learning-platform-local') ? 'bg-white text-[#4E0000] shadow-sm' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-all duration-200">
                        <svg class="w-5 h-5 mr-3 shrink-0 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                        <span>Local Publications</span>
                    </a>
                </li>
                <li>
                    <a href="manage-learning-platforms-foreign" class="flex items-center px-4 py-2.5 rounded-lg <?= ($current_page == 'manage-learning-platforms-foreign' || $current_page == 'new-learning-platform-foreign') ? 'bg-white text-[#4E0000] shadow-sm' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-all duration-200">
                        <svg class="w-5 h-5 mr-3 shrink-0 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"></path></svg>
                        <span>Foreign Publications</span>
                    </a>
                </li>
                <li>
                    <a href="manage-acts" class="flex items-center px-4 py-2.5 rounded-lg <?= ($current_page == 'manage-acts' || $current_page == 'new-act') ? 'bg-white text-[#4E0000] shadow-sm' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-all duration-200">
                        <svg class="w-5 h-5 mr-3 shrink-0 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
        ...
        <div class="mb-6">
            ...
            <ul class="space-y-1 px-3">
                <li>
                    <a href="manage-procurements" class="flex items-center px-4 py-2.5 rounded-lg <?= ($current_page == 'manage-procurements' || $current_page == 'new-procurement') ? 'bg-white text-[#4E0000] shadow-sm' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-all duration-200">
                ...
                <li>
                    <a href="manage-vacancies" class="flex items-center px-4 py-2.5 rounded-lg <?= ($current_page == 'manage-vacancies' || $current_page == 'new-vacancy') ? 'bg-white text-[#4E0000] shadow-sm' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-all duration-200">
        ...
        <div class="mb-6">
            ...
            <ul class="space-y-1 px-3">
                <li>
                    <a href="officials" class="flex items-center px-4 py-2.5 rounded-lg <?= ($current_page == 'officials') ? 'bg-white text-[#4E0000] shadow-sm' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-all duration-200">
                ...
                <li>
                    <a href="bungalow-bookings" class="flex items-center px-4 py-2.5 rounded-lg <?= ($current_page == 'bungalow-bookings') ? 'bg-white text-[#4E0000] shadow-sm' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-all duration-200">
        ...
        <div class="mb-6">
            ...
            <ul class="space-y-1 px-3">
                <li>
                    <a href="settings" class="flex items-center px-4 py-2.5 rounded-lg <?= ($current_page == 'settings') ? 'bg-white text-[#4E0000] shadow-sm' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-all duration-200">
                ...
                <li>
                    <a href="manage-statistics" class="flex items-center px-4 py-2.5 rounded-lg <?= ($current_page == 'manage-statistics') ? 'bg-white text-[#4E0000] shadow-sm' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-all duration-200">
                ...
                <?php if (isSuperAdmin()): ?>
                <li>
                    <a href="manage-admins" class="flex items-center px-4 py-2.5 rounded-lg <?= ($current_page == 'manage-admins') ? 'bg-white text-[#4E0000] shadow-sm' : 'text-white/90 hover:bg-white/5 hover:text-white' ?> font-bold text-[13px] transition-all duration-200">
                        <svg class="w-5 h-5 mr-3 shrink-0 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
