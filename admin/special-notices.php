...
<div class="flex-1 flex flex-col min-w-0 bg-white relative z-10">
    ...
    <main class="flex-1 overflow-x-hidden overflow-y-auto p-10">
        ...
        <div class="flex justify-between items-center mb-8">
            <h2 class="text-3xl font-bold font-montserrat text-gray-900">Special Notices</h2>
        ...
        <div class="flex flex-col md:flex-row gap-4 mb-6">
            <div class="relative flex-1 max-w-2xl">
                ...
                <input type="text" placeholder="Search by notice..." class="js-table-search w-full pl-10 pr-4 py-2.5 bg-[#F9FAFB] border border-gray-100 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-300 text-[13px] text-gray-800 placeholder-gray-400">
            </div>
            ...
            <table class="js-filterable-table w-full text-left border-collapse">
                <thead>
                    <tr class="bg-[#13273F] text-white">
                        <th class="py-4 px-6 font-medium text-[15px]">Notice Title</th>
                        <th class="py-4 px-6 font-medium text-[15px]">Type</th>
                        <th class="py-4 px-6 font-medium text-[15px]">Author</th>
                        <th class="py-4 px-6 font-medium text-[15px]">Posted Date</th>
                ...
                <tbody class="divide-y divide-gray-100 text-[13px]">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="py-5 px-6 font-medium text-gray-900 w-1/3">Amendment to the National Minimum Wage of Workers Act</td>
                        <td class="py-5 px-6 text-gray-800">Amendment</td>
                    ...
                    <!-- Row 2 -->
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="py-5 px-6 font-medium text-gray-900 w-1/3">Notice to Trade Union Executive Committee Members</td>
                        <td class="py-5 px-6 text-gray-800">Trade Unions</td>
                        <td class="py-5 px-6 text-gray-800">A. Silva</td>
