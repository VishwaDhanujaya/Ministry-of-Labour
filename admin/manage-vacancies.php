                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="py-4 px-6 text-right">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <a href="manage-vacancies?delete=<?= $proc['id'] ?>&csrf_token=<?= generateCsrfToken() ?>" data-confirm="Are you sure you want to delete this vacancy?" class="p-1.5 text-gray-400 hover:text-red-500 transition-colors" title="Delete">
