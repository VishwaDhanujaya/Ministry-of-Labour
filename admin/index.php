        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                <div class="flex justify-between items-start mb-4">
                    <div>
                        <p class="text-[13px] font-medium text-gray-500 uppercase tracking-wide">Total News</p>
        ...
        <div class="grid grid-cols-1 gap-8">
            ...
            <div class="col-span-1">
                <div class="flex justify-between items-center mb-5">
                    <h3 class="text-2xl font-bold font-montserrat text-gray-900">Recent News</h3>
                    <a href="news" class="px-5 py-2 border border-[#4E0000] rounded-md text-[13px] font-bold text-[#4E0000] hover:bg-[#4E0000] hover:text-white transition-colors">View All</a>
                </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-100 text-[13px]">
                            ...
                            <tr>
                                <td colspan="5" class="py-12 px-6">
                                    <div class="flex flex-col items-center justify-center text-center">
                                        ...
                                        <p class="text-[13px] text-gray-500">Get started by creating your first news item.</p>
                                    </div>
                                </td>
                            </tr>
                            <?php else: ?>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors group">
                                <td class="py-5 px-6 font-medium text-gray-900"><?= htmlspecialchars($news['title']) ?></td>
                                <td class="py-5 px-6 text-gray-800"><?= htmlspecialchars($news['category']) ?></td>
                                <td class="py-5 px-6 text-gray-800"><?= date('M j, Y', strtotime($news['created_at'])) ?></td>
                                <td class="py-5 px-6">
