...
<div class="flex-1 flex flex-col min-w-0 bg-white relative z-10">
    ...
    <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 md:p-10">
            ...
            <table class="js-filterable-table w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="py-4 px-6">
                            <p class="text-[13px] font-medium text-gray-900"><?= htmlspecialchars($proc['title']) ?></p>
        ...
        <!-- Add/Edit Modal -->
        <div id="procModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 backdrop-blur-sm p-4">
                ...
                <div class="p-6 overflow-y-auto">
                    <form id="procForm" action="" method="POST" enctype="multipart/form-data" class="js-validate-form space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="procDescription" rows="3" placeholder="Brief description of the procurement" class="w-full px-4 py-3 bg-[#F9FAFB] border border-gray-100 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#4E0000] text-[13px] text-gray-900 placeholder-gray-400"></textarea>
                        </div>
        ...
        function openEditModal(proc) {
            ...
            document.getElementById('procDescription').value = proc.description || '';
