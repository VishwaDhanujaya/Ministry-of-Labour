...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($start_date) || empty($end_date) || empty($applicant_name) || empty($telephone) || empty($email) || empty($room_types)) {
        ...
        try {
            ...
            $stmt = $pdo->prepare("INSERT INTO bookings (bungalow_name, applicant_name, phone, email, room_type, start_date, end_date) VALUES (?, ?, ?, ?, ?, ?, ?)");
            foreach ($room_types as $room_type) {
                $stmt->execute(['Ampara', $applicant_name, $telephone, $email, $room_type, $start_date, $end_date]);
            }
            $pdo->commit();
    ...
    <div class="container mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12">
        ...
        <div class="w-full lg:w-[65%]">
            ...
            <div class="mb-10 bg-[#FAFAFA] rounded-[20px] p-6 md:p-8 border-[0.5px] border-[#D4D4D4]">
                ...
                <div class="space-y-4">
                    ...
                    <!-- Room 1 -->
                    <div
                        class="bg-white rounded-[16px] p-6 border-[0.5px] border-[#D4D4D4] flex flex-col md:flex-row justify-between md:items-start gap-6 hover:shadow-sm transition-shadow">
                        <div class="flex-1">
                            <h4 class="text-[18px] font-medium text-gray-900 mb-2 font-montserrat">Double A/C Room</h4>
                            <span
                                class="inline-block px-3 py-1 bg-[#DDF1EC] text-[#42937A] text-[11px] font-medium rounded-full mb-6 font-inter">Double
                                Room</span>
                        ...
                        <div class="text-left md:text-right shrink-0 flex flex-col md:items-end">
                            ...
                            <span
                                class="inline-block px-3 py-1 bg-[#DDF1EC] text-[#42937A] text-[11px] font-medium rounded-full font-inter">Available</span>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            ...
                            <span
                                class="inline-block px-3 py-1 bg-[#DDF1EC] text-[#42937A] text-[11px] font-medium rounded-full mb-6 font-inter">Triple
                                Room</span>
                            <div class="flex flex-col md:flex-row gap-4 md:gap-8 text-[13px] text-gray-800 font-inter">
                                <div class="flex items-center gap-2 shrink-0">
                                    <svg class="w-4 h-4 text-gray-600" fill="none" stroke="currentColor"
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            ...
                            <span
                                class="inline-block px-3 py-1 bg-[#DDF1EC] text-[#42937A] text-[11px] font-medium rounded-full mb-6 font-inter">Suite</span>
                            <div class="flex flex-col md:flex-row gap-4 md:gap-8 text-[13px] text-gray-800 font-inter">
                                <div class="flex items-center gap-2 shrink-0">
                                    <svg class="w-4 h-4 text-gray-600" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-sm text-gray-600">
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            <tr>
                                <td class="px-4 py-4 font-medium text-gray-900">VIP Room <span
                                        class="ml-1 text-[11px] bg-[#E1F0FF] text-[#0058B9] px-2 py-0.5 rounded-full font-normal">A/C</span>
                                </td>
                            ...
                            <tr>
                                <td class="px-4 py-4 font-medium text-gray-900">A/C Triple Room <span
                                        class="ml-1 text-[11px] bg-[#E1F0FF] text-[#0058B9] px-2 py-0.5 rounded-full font-normal">A/C</span>
                                </td>
                            ...
                            <tr>
                                <td class="px-4 py-4 font-medium text-gray-900">A/C Double Room <span
                                        class="ml-1 text-[11px] bg-[#E1F0FF] text-[#0058B9] px-2 py-0.5 rounded-full font-normal">A/C</span>
                                </td>
                                <td class="px-4 py-4">01</td>
                                <td class="px-4 py-4">2 Persons</td>
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-4 text-right"><span
                                        class="text-[12px] bg-green-100 text-green-700 px-2 py-1 rounded-full font-medium whitespace-nowrap">Free
                                        of Charge</span></td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <div class="w-full lg:w-[35%] lg:sticky lg:top-32 lg:self-start space-y-6">
            ...
            <div class="bg-[#FAFAFA] rounded-[20px] p-6 border-[0.5px] border-[#D4D4D4] shadow-sm">
                ...
                <div class="space-y-3">
                    <button type="button"
                        onclick="document.getElementById('booking-modal').classList.remove('hidden'); document.getElementById('booking-modal').classList.add('flex');"
...
<!-- Booking Modal -->
<div id="booking-modal" class="fixed inset-0 z-50 hidden bg-black/60 items-center justify-center p-4">
    <div class="bg-white rounded-[20px] shadow-xl w-full max-w-md overflow-hidden transform transition-all">
        <div class="flex justify-between items-center p-6 border-b border-gray-100">
            ...
            <button type="button"
                onclick="document.getElementById('booking-modal').classList.add('hidden'); document.getElementById('booking-modal').classList.remove('flex');"
        ...
        <form id="booking-form" method="POST" action="">
            <div class="p-6 space-y-4">
                <p class="text-[13px] text-gray-600 font-inter mb-4">Please fill in your details to request a
                    reservation for the selected dates. Grey dates are already booked.</p>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="modal-check-in" name="start_date" required
                            class="w-full border border-gray-300 rounded-lg py-2.5 px-3 text-sm text-gray-900 focus:outline-none focus:ring-1 focus:ring-[#4E0000] focus:border-[#4E0000] bg-white font-inter"
                ...
                <div>
                    ...
                    <div id="room_type_container"
                        class="space-y-2 p-3 border border-gray-300 rounded-lg bg-gray-50 min-h-[42px]">
                        <p class="text-[13px] text-gray-500 font-inter m-0">Please select dates first</p>
                    </div>
                    <p id="room-availability-msg" class="text-[11px] text-red-600 mt-1 hidden"></p>
                </div>

                <!-- Applicant Name -->
                <div>
                    <label class="block text-[12px] font-medium text-gray-700 mb-1.5 font-inter">Applicant Name
                        *</label>
            ...
            <div class="p-6 bg-[#FAFAFA] border-t border-gray-100 flex justify-end gap-3 rounded-b-[20px]">
                <button type="button"
                    onclick="document.getElementById('booking-modal').classList.add('hidden'); document.getElementById('booking-modal').classList.remove('flex');"
                    class="px-5 py-2.5 text-[13px] font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors font-inter">Cancel</button>
                <button type="submit" id="submit-booking-btn"
                    class="px-5 py-2.5 text-[13px] font-medium text-white bg-[#4E0000] hover:bg-[#320000] rounded-lg transition-colors font-inter shadow-sm">Submit
                    Request</button>
            </div>
        </form>
    </div>
                    ...
                    .then(data => {
                        ...
                        if (data.success && data.available_rooms.length > 0) {
                            data.available_rooms.forEach(room => {
                                ...
                                label.className = 'flex items-center w-full p-3 text-gray-700 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-[#4E0000] peer-checked:bg-red-50 hover:bg-gray-50 peer-disabled:opacity-50 peer-disabled:cursor-not-allowed transition-all shadow-sm';

                                const span = document.createElement('span');
                                span.className = 'text-[13px] font-medium font-inter pr-6';
