...
<section class="py-12 md:py-16 px-4 md:px-16 bg-white min-h-[50vh]">
    <div class="container mx-auto max-w-6xl">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            <h2 class="text-[24px] font-bold font-montserrat text-primary">Procurements</h2>
                            ...
                            <tr class="hover:bg-gray-50/80 transition-colors group search-row">
                                ...
                                <td class="px-6 py-4 text-right whitespace-nowrap">
                                    <div class="flex items-center justify-end gap-3">
                                        <button type="button" data-pdf-url="admin/<?= htmlspecialchars($proc['pdf_path']) ?>" data-pdf-title="<?= htmlspecialchars($proc['title']) ?>" class="open-pdf-modal inline-flex items-center text-[#4E0000] hover:text-[#320000] text-[13px] font-semibold transition-colors focus:outline-none bg-red-50 hover:bg-red-100 px-3 py-1.5 rounded-md">
                                            <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                                            View
                                        </button>
                                        <a href="admin/<?= htmlspecialchars($proc['pdf_path']) ?>" download class="inline-flex items-center text-[#4E0000] hover:text-[#320000] text-[13px] font-semibold transition-colors bg-red-50 hover:bg-red-100 px-3 py-1.5 rounded-md">
