...
$metaDescription = 'Download important procurement notices, tender documents, and bids from the Ministry of Labour, Sri Lanka.';
$metaKeywords = 'Procurements, Tenders, Bids, Notices, Ministry of Labour, Sri Lanka';
    ...
    <div class="container mx-auto max-w-6xl">
        ...
        <div class="flex flex-col md:flex-row gap-4 mb-8">
            <div class="relative flex-1 w-full md:max-w-[60%]">
                ...
                <input type="text" id="searchInput" class="bg-[#FAFAFA] border border-[#E5E7EB] text-gray-900 text-[13px] rounded-lg focus:ring-secondary focus:border-secondary block w-full pl-10 py-2.5 font-inter transition-colors outline-none" placeholder="Search procurements by title..." onkeyup="filterTable()">
            </div>
        </div>

        <!-- Section Title -->
        <h2 class="text-[20px] font-medium font-montserrat text-primary mb-4">Procurement Notices & Tenders</h2>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm text-gray-600 font-inter" id="dataTable">
                    ...
                    <tbody class="divide-y divide-[#E5E7EB]">
                        ...
                        <tr>
                            <td colspan="3" class="px-6 py-8 text-center text-gray-500">No procurements available at the moment.</td>
                        </tr>
                        <?php else: ?>
                        ...
                        <tr class="hover:bg-gray-50/80 transition-colors group">
                            <td class="px-6 py-4">
                                ...
                                <p class="text-[13px] text-gray-500 mt-1"><?= htmlspecialchars($proc['description']) ?></p>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="px-6 py-4 text-right whitespace-nowrap">
                                <div class="flex items-center justify-end gap-3">
                                    <button type="button" data-pdf-url="admin/<?= htmlspecialchars($proc['pdf_path']) ?>" data-pdf-title="<?= htmlspecialchars($proc['title']) ?>" class="open-pdf-modal inline-flex items-center text-[#4E0000] hover:text-[#320000] text-[13px] font-semibold transition-colors focus:outline-none">
                                        <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                                        View
                                    </button>
                                    <span class="text-gray-300">|</span>
                                    <a href="admin/<?= htmlspecialchars($proc['pdf_path']) ?>" download class="inline-flex items-center text-[#4E0000] hover:text-[#320000] text-[13px] font-semibold transition-colors">
