                        ...
                        <tr class="hover:bg-gray-50/80 transition-colors group">
                            ...
                            <td class="px-6 py-4 text-right whitespace-nowrap">
                                <div class="flex items-center justify-end gap-3">
                                    <a href="admin/<?= htmlspecialchars($proc['pdf_path']) ?>" target="_blank" class="inline-flex items-center text-[#4E0000] hover:text-[#320000] text-[13px] font-semibold transition-colors">
