...
<body class="bg-white text-gray-800 antialiased scroll-smooth flex flex-col min-h-screen">
    ...
    <div class="hidden md:flex bg-gradient-to-r from-primary via-[#2D2D43] to-primary text-white/90 text-[11px] md:text-xs min-h-10 py-1.5 md:py-0 px-3 sm:px-4 md:px-8 flex-row justify-between items-center font-inter border-b border-white/10 relative z-55 shadow-inner">
        ...
        <div class="container mx-auto px-4 md:px-8 py-3.5 flex justify-between items-center">
            ...
            <nav class="hidden xl:flex items-center <?= $nav_spacing_class ?> font-bold text-gray-700 notranslate whitespace-nowrap">
                ...
                <div class="relative group">
                    ...
                    <!-- Dropdown -->
                    <div class="absolute right-0 left-auto mt-0 min-w-[260px] w-max max-w-[380px] bg-white border border-gray-100 rounded-xl shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 transform translate-y-2 group-hover:translate-y-0 overflow-hidden">
                        <div class="py-1">
                ...
                <div class="relative group">
                    ...
                    <!-- Dropdown -->
                    <div class="absolute right-0 left-auto mt-0 min-w-[240px] w-max max-w-[360px] bg-white border border-gray-100 rounded-xl shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 transform translate-y-2 group-hover:translate-y-0 overflow-hidden">
                        <div class="py-1">
        ...
        <div id="mobile-menu-drawer"
            ...
            <div class="border-t border-gray-100 pt-6 mt-6 flex flex-col space-y-4 notranslate">
                ...
                <div class="flex justify-center space-x-5 text-gray-400 py-2">
                    ...
                    <a href="https://wa.me/94707227877" aria-label="WhatsApp Link" target="_blank" rel="noopener noreferrer" class="hover:text-[#25D366] transition-colors duration-200"><svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
