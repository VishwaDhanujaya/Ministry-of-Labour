    ...
    <div class="relative notranslate" id="accessibility-menu-container">
        <!-- Floating Action Button (Positioned top left under Navbar with high-contrast borders and shadows) -->
