...
// Detect active language from cookie or URL parameter
$current_lang = 'en';
...
<section class="py-16 md:py-24 px-4 md:px-16 bg-[#F1F5F9] border-t border-b border-slate-200/80 shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)]">
    <div class="container mx-auto max-w-5xl">
        ...
        <div class="text-center max-w-3xl mx-auto mb-16" data-aos="fade-up">
            <span class="text-secondary font-semibold text-xs md:text-sm tracking-[0.2em] uppercase mb-3 block font-inter notranslate"><?= htmlspecialchars($content['section_subtitle']) ?></span>
            <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold font-montserrat text-primary uppercase tracking-tight mb-6 notranslate"><?= htmlspecialchars($content['section_title']) ?></h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mb-16">
            ...
            <div class="group relative bg-white border border-gray-100 rounded-[32px] p-8 md:p-10 shadow-[0_10px_30px_-5px_rgba(19,39,63,0.03)] hover:shadow-[0_20px_40px_-5px_rgba(19,39,63,0.08)] hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between overflow-hidden" data-aos="fade-right">
                ...
                <div class="relative z-10">
                    ...
                    <!-- Card Title -->
                    <h3 class="text-xl md:text-2xl font-bold font-montserrat text-primary mb-4 notranslate"><?= htmlspecialchars($content['cms_card_title']) ?></h3>
                    <!-- Card Description -->
            ...
            <div class="group relative bg-[#EFF8F6] border border-teal-100 rounded-[32px] p-8 md:p-10 shadow-[0_10px_30px_-5px_rgba(13,148,136,0.03)] hover:shadow-[0_20px_40px_-5px_rgba(13,148,136,0.08)] hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between overflow-hidden" data-aos="fade-left">
                ...
                <div class="relative z-10">
                    ...
                    <!-- Card Title -->
                    <h3 class="text-xl md:text-2xl font-bold font-montserrat text-teal-900 mb-4 notranslate"><?= htmlspecialchars($content['whatsapp_card_title']) ?></h3>
                    <!-- Card Description -->
                ...
                <div class="relative z-10">
                    <a href="<?= htmlspecialchars($content['whatsapp_link']) ?>" target="_blank" rel="noopener noreferrer" class="w-full text-center inline-flex items-center justify-center bg-teal-600 hover:bg-teal-700 text-white text-xs font-bold px-6 py-4 rounded-xl transition-all duration-300 font-montserrat tracking-wider uppercase shadow-md hover:shadow-lg active:scale-[0.98] notranslate">
        ...
        <div class="bg-white border-t-4 border-primary rounded-3xl p-6 md:p-8 shadow-[0_10px_25px_-5px_rgba(19,39,63,0.02)]" data-aos="fade-up" data-aos-delay="100">
            <div class="flex items-start gap-4">
                ...
                <div>
                    <h4 class="text-base font-bold text-primary font-montserrat mb-2 notranslate"><?= htmlspecialchars($content['note_title']) ?></h4>
