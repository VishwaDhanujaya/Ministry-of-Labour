    ...
    <div class="container mx-auto max-w-6xl">
        ...
        <div class="flex flex-col md:flex-row gap-4 mb-8">
            <div class="relative flex-1 w-full md:max-w-[60%]">
                ...
                <input type="text" id="searchInput" class="bg-[#FAFAFA] border border-[#E5E7EB] text-gray-900 text-[13px] rounded-lg focus:ring-secondary focus:border-secondary block w-full pl-10 py-2.5 font-inter transition-colors outline-none" placeholder="Search IAU updates by title..." onkeyup="filterTable()">
            </div>
        </div>

        <!-- Section Title -->
        <h2 class="text-[20px] font-medium font-montserrat text-primary mb-4">Internal Audit Unit (IAU) Updates</h2>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm text-gray-600 font-inter" id="dataTable">
                    ...
                    <tbody class="divide-y divide-[#E5E7EB]">
                        ...
                        <tr>
                            <td colspan="2" class="px-6 py-8 text-center text-gray-500">No IAU updates available at the moment.</td>
                        </tr>
                        <?php else: ?>
