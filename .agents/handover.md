...
* **Change Description:**
  ...
  - **Suppressed Empty Previews & Word-Boundary Truncation**: Added `truncate_to_word_boundary()` in [includes/translations.php](file:///c:/xampp/htdocs/Ministry-of-Labour/includes/translations.php) to cleanly cut descriptions at complete word boundaries (~3 lines, 130 characters) without slicing words in half. Updated [events.php](file:///c:/xampp/htdocs/Ministry-of-Labour/events.php), [news.php](file:///c:/xampp/htdocs/Ministry-of-Labour/news.php), and [index.php](file:///c:/xampp/htdocs/Ministry-of-Labour/index.php) to use this helper alongside CSS `line-clamp-3` and `whitespace-nowrap` for tidy, uniform card layouts across English, Sinhala, and Tamil.
