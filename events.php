                        ...
                        <div class="article-card bg-white rounded-[20px] overflow-hidden shadow-[0_4px_20px_rgb(0,0,0,0.04)] border border-gray-100 hover:shadow-lg transition-shadow duration-300 flex flex-col" data-index="<?= $index ?>">
                            ...
                            <div class="p-8 pt-6 pb-8 flex flex-col flex-grow">
                                ...
                                <div class="text-gray-500 text-[14px] font-inter leading-relaxed line-clamp-3 flex-grow">
                                    ...
                                    <a href="<?= navUrl('events/' . $article['id']) ?>" class="text-secondary font-bold hover:text-[#320000] transition-colors ml-1 whitespace-nowrap notranslate"><?= t('read_more', 'Read More') ?></a>
                                    <?php endif; ?>
                                </div>
                                <?php else: ?>
