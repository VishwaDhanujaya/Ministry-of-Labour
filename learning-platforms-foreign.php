...
$breadcrumbs = [
    ...
    ['label' => t('foreign_publications', 'Foreign Publications')]
];
...
function changeView(view) {
    ...
    if (foreignPlatformsPaginator) {
        foreignPlatformsPaginator.setView(view);
    }
}
...
function filterTable() {
    ...
    if (foreignPlatformsPaginator) {
        foreignPlatformsPaginator.setFilteredIndexes(filteredIndexes);
    }
}
...
document.addEventListener('DOMContentLoaded', () => {
    foreignPlatformsPaginator = new ContentPaginator({
        items: documents,
