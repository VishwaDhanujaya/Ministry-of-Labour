...
<section class="py-16 md:py-24 px-4 md:px-16 bg-white">
    <div class="container mx-auto max-w-6xl">
        ...
        <div class="flex flex-col lg:flex-row rounded-2xl overflow-hidden border border-gray-200 mb-16 md:mb-20 shadow-sm">
            <!-- Address -->
            <div class="flex-1 bg-secondary text-white p-6 sm:p-8 lg:p-10 flex flex-col items-start justify-center">
                <div class="flex items-center gap-4 mb-4">
                    <div class="w-10 h-10 md:w-11 md:h-11 bg-white rounded-full flex items-center justify-center shrink-0">
            ...
            <!-- Phone -->
            <div class="flex-1 bg-[#FAFAFA] p-6 sm:p-8 lg:p-10 flex flex-col items-start justify-center border-b lg:border-b-0 lg:border-r border-gray-200">
                <div class="flex items-center gap-4 mb-4">
                    <div class="w-10 h-10 md:w-11 md:h-11 bg-secondary rounded-full flex items-center justify-center shrink-0">
            ...
            <!-- Email -->
            <div class="flex-1 bg-[#FAFAFA] p-6 sm:p-8 lg:p-10 flex flex-col items-start justify-center">
                <div class="flex items-center gap-4 mb-4">
                    <div class="w-10 h-10 md:w-11 md:h-11 bg-secondary rounded-full flex items-center justify-center shrink-0">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-px bg-gray-200 border border-gray-200 rounded-2xl overflow-hidden font-inter">
            <!-- Row 1 -->
            <div onclick="openModal('minister-modal')" class="bg-[#FAFAFA] cursor-pointer py-6 md:py-8 px-2 sm:px-4 flex items-center justify-center font-medium text-gray-900 text-sm md:text-[15px] hover:bg-gray-100 transition-colors text-center h-full">Minister</div>
            <div class="bg-[#FAFAFA] py-6 md:py-8 px-2 sm:px-4 flex items-center justify-center font-medium text-gray-900 text-sm md:text-[15px] hover:bg-gray-100 transition-colors text-center h-full">Deputy Minister</div>
            <div class="bg-[#FAFAFA] py-6 md:py-8 px-2 sm:px-4 flex items-center justify-center font-medium text-gray-900 text-sm md:text-[15px] hover:bg-gray-100 transition-colors text-center h-full">Secretary</div>
            <div class="bg-[#FAFAFA] py-6 md:py-8 px-2 sm:px-4 flex items-center justify-center font-medium text-gray-900 text-sm md:text-[15px] hover:bg-gray-100 transition-colors text-center h-full">Administration Division</div>
            
            <!-- Row 2 -->
            <div class="bg-[#FAFAFA] py-6 md:py-8 px-2 sm:px-4 flex items-center justify-center font-medium text-gray-900 text-sm md:text-[15px] hover:bg-gray-100 transition-colors text-center h-full">Development Division</div>
            <div class="bg-[#FAFAFA] py-6 md:py-8 px-2 sm:px-4 flex items-center justify-center font-medium text-gray-900 text-sm md:text-[15px] hover:bg-gray-100 transition-colors text-center h-full">Planning Division</div>
            <div class="bg-[#FAFAFA] py-6 md:py-8 px-2 sm:px-4 flex items-center justify-center font-medium text-gray-900 text-sm md:text-[15px] hover:bg-gray-100 transition-colors text-center h-full">Finance Division</div>
            <div class="bg-[#FAFAFA] py-6 md:py-8 px-2 sm:px-4 flex items-center justify-center font-medium text-gray-900 text-sm md:text-[15px] hover:bg-gray-100 transition-colors text-center h-full">Internal Audit</div>
        </div>
...
<div id="minister-modal" class="fixed inset-0 z-[110] hidden opacity-0 transition-opacity duration-300">
    ...
    <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-[600px] bg-secondary rounded-2xl shadow-2xl p-6 sm:p-8 md:p-12 text-center text-white">
        <button onclick="closeModal('minister-modal')" class="absolute top-4 right-4 md:top-6 md:right-6 text-white hover:text-gray-300 transition-colors">
        ...
        <h3 class="text-xl md:text-[26px] font-semibold font-montserrat mb-4 md:mb-6">Minister</h3>
        
        <hr class="border-white/50 w-[85%] mx-auto mb-6 md:mb-8">
        
        <div class="space-y-2 md:space-y-3 font-inter">
            <p class="text-[20px] sm:text-2xl md:text-[28px] font-semibold font-montserrat mb-1 md:mb-2 leading-tight">Hon. Minister Anil Jayantha Fernando</p>
            <p class="text-base md:text-lg pb-1 md:pb-2">Minister of Labour</p>
            <p class="text-xs md:text-[15px]">Tel: +9411 236 8175</p>
            <p class="text-xs md:text-[15px]">Fax: +9411 258 8950</p>
            <p class="text-xs md:text-[15px]">Email: minister@labourmin.gov.lk</p>
        </div>
    </div>
</div>
