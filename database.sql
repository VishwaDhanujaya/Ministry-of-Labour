...
INSERT INTO `articles` (`id`, `title`, `title_si`, `title_ta`, `category`, `publish_date`, `summary`, `content`, `content_si`, `content_ta`, `cover_image`, `tags`, `language`, `visibility`, `is_featured`, `is_special_notice`, `status`, `author_id`, `created_at`, `updated_at`) VALUES
