...
$breadcrumbs = [
    ['label' => t('learning_platforms', 'Learning Platforms'), 'url' => 'learning-platforms'],
    ['label' => t('local_publications', 'Local Publications')]
];
...
$all_documents = [];
$categoryColors = [
    'Local Publication' => 'bg-purple-50 text-purple-700 border-purple-100'
];
...
<section class="py-12 md:py-16 px-4 md:px-16 bg-[#F9FAFB] min-h-[75vh]">
    <div class="container mx-auto max-w-6xl">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-8 notranslate">
            <div class="flex flex-col lg:flex-row gap-4 items-stretch lg:items-center justify-between">
                ...
                <div class="relative flex-1">
                    ...
                    <input type="text" id="searchInput" class="bg-gray-50/50 border border-gray-200 text-gray-900 text-sm rounded-xl focus:ring-secondary focus:border-secondary block w-full pl-11 pr-4 py-3 font-inter transition-all outline-none" placeholder="<?= t('search_publications_placeholder', 'Search local publications by title or date...') ?>" onkeyup="resetPaginationAndFilter()">
                </div>
        ...
        <div id="gridViewContainer" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8 notranslate" translate="no" style="display: none;">
        ...
        <div id="noResultsMsg" class="flex flex-col items-center justify-center py-16 px-4 bg-white rounded-3xl border border-gray-100 shadow-sm notranslate" style="display: none;">
            ...
            <p class="text-[17px] font-bold text-gray-800 mb-1"><?= t('no_publications_found', 'No publications matched your search') ?></p>
...
function changeView(view) {
    ...
    if (localPlatformsPaginator) {
        localPlatformsPaginator.setView(view);
    }
}
...
function filterTable() {
    ...
    if (localPlatformsPaginator) {
        localPlatformsPaginator.setFilteredIndexes(filteredIndexes);
    }
}
...
document.addEventListener('DOMContentLoaded', () => {
    localPlatformsPaginator = new ContentPaginator({
        items: documents,
