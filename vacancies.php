    ...
    <div class="container mx-auto max-w-6xl">
        ...
        <div class="flex flex-col md:flex-row gap-4 mb-8">
            <div class="relative flex-1 w-full md:max-w-[60%]">
                ...
                <input type="text" id="searchInput" class="bg-[#FAFAFA] border border-[#E5E7EB] text-gray-900 text-[13px] rounded-lg focus:ring-secondary focus:border-secondary block w-full pl-10 py-2.5 font-inter transition-colors outline-none" placeholder="Search vacancies by title..." onkeyup="filterTable()">
            </div>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm text-gray-600 font-inter" id="dataTable">
                    ...
                    <tbody class="divide-y divide-[#E5E7EB]">
                        ...
                        <tr>
                            <td colspan="3" class="px-6 py-8 text-center text-gray-500">No vacancies available at the moment.</td>
                        </tr>
                        <?php else: ?>
