...
function updatePaginationUI(itemsPerPage) {
    ...
    // Update summary text
    updatePaginationSummary(startIdx, endIdx, totalItems, 'notices');
}

function updatePaginationSummary(startIdx, endIdx, totalItems, entityType = 'notices') {
    ...
    const entity = entityNames[entityType] || entityNames.notices;
