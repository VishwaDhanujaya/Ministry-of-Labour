...
<section class="py-12 md:py-16 px-4 md:px-16 bg-white min-h-[50vh]">
    <div class="container mx-auto max-w-6xl">
        ...
        <!-- Section Title -->
        <h2 class="text-[20px] font-medium font-montserrat text-primary mb-4">Special Notices</h2>
                ...
                <table class="w-full text-left text-sm text-gray-600 font-inter" id="dataTable">
                    ...
                    <tbody class="divide-y divide-[#E5E7EB]">
                        ...
                        <tr class="hover:bg-gray-50/80 transition-colors group">
                            <td class="px-6 py-4">
                                <h3 class="font-medium text-gray-900 text-[14px]"><?= htmlspecialchars($notice['title']) ?></h3>
