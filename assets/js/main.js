                    ...
                    .then(data => {
                        ...
                        if (data.length === 0) {
                            ...
                            data.forEach(item => {
                                ...
                                html += `
                                    <a href="${item.url}" class="suggestion-item px-4 py-3 hover:bg-gray-50/80 transition-all duration-200 border-l-4 border-l-transparent flex items-center justify-between gap-3">
